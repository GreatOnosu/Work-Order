...
<body>
	...
	<nav id="breadcrumb">
		...
		<div class="crumbs">
			<span><a href="student/index">Dashboard</a></span>
		</div>
	</nav>
	<section>
		<div class="admin-body">
			<div class="body-links">
				<a href="Student/maintenance" class="link-data" style="background-color: #479129;"><div>
					<p>Request <br /> Maintenance</p>
				</div></a>
				<a href="Student/status" class="link-data" style="background-color: #F8CB00;"><div>
					<p>Check <br /> Status</p>
				</div></a>
			</div>
			<div class="body-info">
