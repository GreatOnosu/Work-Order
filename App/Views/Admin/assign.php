...
<body>
	...
	<nav id="breadcrumb">
		...
		<div class="crumbs">
			<span><a href="Admin/index">Dashboard</a> / </span><span><a href="Admin/assign">Assigned Orders</a></span>
		</div>
	</nav>
	<section>
			...
			<div class="body-info">
				...
				<table>
					<tr>
				  	...
				  	<?php foreach($records as $record):?><form action="admin/assign" method="post">
				  	<tr>
				  		<td><?=$record->title?></td>
				  		...
				  		<td>
							<select name="it_allocate" required>
								...
								<?php endforeach;?>
							</select><input type="hidden" name="id" value="<?=$record->id?>" />
						</td>
						<td>
