...
<body>
	...
	<nav id="breadcrumb">
		...
		<div class="crumbs">
			<span><a href="staff/indexexam">Dashboard</a> / </span><span><a href="staff/acceptmain">Accept</a></span>
		</div>
	</nav>
	<section>
				...
				<table>
					<tr>
				  	...
				  	<tr>
				  		...
				  		<td>
				  		<form action="staff/acceptmain" method="post">
				  			<input type="hidden" class="btn-login" name="accept_id" value="<?=$record->id?>" />
							<input type="submit" class="btn-login" name="accept_main" value="Accept" />
						</form>
						</td>
				  	</tr>
				  	<?php endforeach;?>
